                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-4">
                                        <div class="plan-card active" data-plan="free">
                                            ...
                                            <input type="radio" class="d-none" name="subscription_plan" value="free" checked>
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-4">
                                        <div class="plan-card featured" data-plan="premium">
                                            ...
                                            <input type="radio" class="d-none" name="subscription_plan" value="premium">
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-4">
                                        <div class="plan-card" data-plan="annual">
                                            ...
                                            <input type="radio" class="d-none" name="subscription_plan" value="annual">
                                        </div>
                                    </div>
                                </div>
                            </div>
