                        ...
                        <div class="tab-pane fade" id="business" role="tabpanel">
                            <div class="text-start mt-3">
                                <div class="mb-3">
                                    ...
                                    <p class="form-control bg-transparent text-white">Restaurante La Parrilla</p>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Categoría:</label>
                                    <p class="form-control bg-transparent text-white">Restaurante</p>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Dirección:</label>
                                    <p class="form-control bg-transparent text-white">Calle Larios 15, Málaga</p>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Teléfono:</label>
                                    <p class="form-control bg-transparent text-white">+34 952 123 456</p>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Horario:</label>
                                    <p class="form-control bg-transparent text-white">13:00-16:00 / 20:00-23:30</p>
                                </div>
                                <a href="editar-info.html" class="btn btn-sm btn-outline-light w-100">Editar Información</a>
                            </div>
                        </div>
                            ...
                            <div class="mt-3 text-start">
                                ...
                                <div class="partner-card p-3 mb-3">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <h6 class="mb-1">Plan Partner Premium</h6>
                                            <small class="text-muted">Incluye 5 QR activos y analíticas avanzadas</small>
                                        </div>
                                ...
                                <h5 class="mt-4 mb-3">Beneficios Premium</h5>
                                <ul class="list-group mb-3">
                                    <li class="list-group-item bg-transparent text-white border-white">
                                        <i class="fas fa-check-circle text-success me-2"></i> Hasta 5 QR activos
                                    </li>
                                    <li class="list-group-item bg-transparent text-white border-white">
                                        <i class="fas fa-check-circle text-success me-2"></i> Estadísticas avanzadas
                                    </li>
                                    <li class="list-group-item bg-transparent text-white border-white">
                                        <i class="fas fa-check-circle text-success me-2"></i> Campañas promocionales
                                    </li>
                                    <li class="list-group-item bg-transparent text-white border-white">
                                        <i class="fas fa-check-circle text-success me-2"></i> Posicionamiento destacado
                                    </li>
                                </ul>
            ...
            <div class="col-md-8">
                ...
                <div class="partner-card p-4 mb-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h2><i class="fas fa-qrcode me-2"></i>Tus Códigos QR</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="location-card">
                                <img src="https://via.placeholder.com/300x150?text=QR+Entrada" alt="Entrada" class="location-image">
                                <div class="location-overlay">
                                    <h6 class="mb-0">QR Entrada</h6>
                                    <small>55 escaneos</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="location-card">
                                <img src="https://via.placeholder.com/300x150?text=QR+Terrazza" alt="Terraza" class="location-image">
                                <div class="location-overlay">
                                    <h6 class="mb-0">QR Terraza</h6>
                                    <small>23 escaneos</small>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-center mt-3">
                        <a href="misQR.html" class="btn btn-outline-light">
                            <i class="fas fa-ellipsis-h me-1"></i> Ver todos (5/5 activos)
                        </a>
                    </div>
                </div>
